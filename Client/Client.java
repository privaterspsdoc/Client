...
public class Client extends RSApplet {
	...
	public static int frameHeight = 515;
	...
	public boolean getMousePositions() {
		...
		if (mouseInRegion2(frameWidth - 216, frameWidth, 0, 172)) {
			return false;
		}
		if (!changeTabArea) {
	...
	private void drawChatArea() {
		...
		if (messagePromptRaised) {
						...
						if (chatTypeView == 2 || chatTypeView == 0) {
							if (yPos > 0 && yPos < 210) {
								newRegularFont.drawBasicString(
										"To " + s1 + ":", 11, yPos + yOffset, changeChatArea ? 0xffffff : 0, changeChatArea ?  0 : -1);
								newRegularFont.drawBasicString(
										chatMessages[k],
										15 + newRegularFont.getTextWidth("To :"
												+ s1), yPos + yOffset, changeChatArea ? 0xFF00D4 : 0x800000, changeChatArea ?  0 : -1);
							}
							j++;
							j77++;
						}
					...
					if (chatType == 8
						...
						if (chatType == 11 && (clanChatMode == 0)) {
							if (chatTypeView == 11) {
								if (yPos > 0 && yPos < 110)
									newRegularFont.drawBasicString(s1 + " "
											+ chatMessages[k], 19, yPos + yOffset,
											0x7e3200, changeChatArea ?  0 : -1);
								j++;
								j77++;
							}
							...
							if (chatTypeView == 11 || chatTypeView == 0) {
								if (yPos > 3 && yPos < 130) {
									...
									newRegularFont.drawBasicString("[" + title
											+ "] " + username + ": " + message,
											11, yPos + yOffset, changeChatArea ? 0xFFFFFF : 0, changeChatArea ?  0 : -1);
								}
								j++;
								j77++;
							}
					...
					if (chatType == 16) {
						...
						if (chatTypeView == 11 || chatTypeView == 0) {
							if (yPos > 0 && yPos < 110)
								...
								case 2:
									j2 += clanNameWidth;
									modIcons[2].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 3:
									j2 += clanNameWidth;
								...
								case 4:
									j2 += clanNameWidth;
									modIcons[3].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 5:
									j2 += clanNameWidth;
									modIcons[4].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 6:
									j2 += clanNameWidth;
									modIcons[5].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 7:
									j2 += clanNameWidth;
									modIcons[6].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 8:
									j2 += clanNameWidth;
									modIcons[7].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 9:
									j2 += clanNameWidth;
									modIcons[8].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								case 10:
									j2 += clanNameWidth;
									modIcons[10].drawSprite(j2 - 18, yPos - 12 + yOffset);
									j2 += 15;
									break;
								default:
									j2 += clanNameWidth;
							...
							newRegularFont
									.drawBasicString("[", 19, yPos + yOffset, changeChatArea ? 0xffffff : 0, changeChatArea ? 0 : -1);
							newRegularFont.drawBasicString("]",
									clanNameWidth + 16 + 11, yPos, changeChatArea ? 0xffffff : 0, changeChatArea ? 0 : -1);
							newRegularFont.drawBasicString(""
									+ capitalize(clanname) + "", 25, yPos + yOffset, changeChatArea ? 0x7FA9FF : 255,
											changeChatArea ? 0 : -1);
							newRegularFont.drawBasicString(
							...
							newRegularFont.drawBasicString(
									capitalize(chatMessages[k]), j2 - 16, yPos + yOffset,
									changeChatArea ? 0xFF00D4 : 0x800000, changeChatArea ? 0 : -1);
			...
			if (myPrivilege == 0) { // Player
				newRegularFont.drawBasicString(fixedString + "", 11, 133 + yOffset, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 12, 123 + yOffset);
				textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 133 + yOffset, (26) + textDrawingArea.getTextWidth(s));
				newRegularFont.drawBasicString(inputString + ((loopCycle % 40 < 20) ? "|" : ""),
						24 + textDrawingArea.getTextWidth(s + ": "), 133 + yOffset, changeChatArea ? 0x7FA9FF : 255,
								changeChatArea ?  0 : -1);
			} else if (myPrivilege == 1) { // Moderator
				modIcons[0].drawSprite(10 + xPos, 122 + yPos + yOffset);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133 + yOffset, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
						123 + yOffset);
				textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 133 + yOffset,
						(38 + textDrawingArea.getTextWidth(s)));
				newRegularFont.drawBasicString(inputString
						+ ((loopCycle % 40 < 20) ? "|" : ""),
						36 + textDrawingArea.getTextWidth(s + ": "), 133 + yOffset, changeChatArea ? 0x7FA9FF : 255,
								changeChatArea ?  0 : -1);
				...
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133 + yOffset, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				modIcons[9].drawSprite(24, 123 + yOffset);// was 124
				textDrawingArea.method385(changeChatArea ? 0xFFFFFF : 0, ": ", 10,
						(38 + textDrawingArea.getTextWidth(s)));
				newRegularFont.drawBasicString(inputString
						+ ((loopCycle % 40 < 20) ? "|" : ""),
						36 + textDrawingArea.getTextWidth(s + ": "), 133 + yOffset, changeChatArea ? 0x7FA9FF : 255,
				...
				modIcons[7].drawSprite(9 + xPos, 122 + yPos + yOffset);
				xPos += 14;
				newRegularFont
						.drawBasicString(fixedString + "", 23, 133 + yOffset, changeChatArea ? 0xFFFFFF : 0, changeChatArea ? 0 : -1);
				modIcons[9].drawSprite(textDrawingArea.getTextWidth(s) + 24,
	...
	private final int[] 
		...
		public void drawSideIcons() {
			...
			if (frameMode == ScreenMode.FIXED || frameMode == ScreenMode.RESIZABLE && !changeTabArea) {
		...
		private void drawTabArea() {
			...
			if (frameMode == ScreenMode.FIXED) {
				...
				cacheSprite[31].drawSprite(xOffset, yOffset);
			} else {
				if (frameWidth >= 1000) {
					if (showTabComponents) {
						DrawingArea.method335(0x3E3529, frameHeight - 304, 197, 265, transparentTabArea ? 80 : 256, frameWidth - 197);
						cacheSprite[34].drawSprite(frameWidth - 204, frameHeight - 311);
					}
					...
					if (showTabComponents) {
						...
						cacheSprite[34].drawSprite(frameWidth - 204, frameHeight - 348);
					}
	...
	public void drawMenu(int x, int y) {
		...
		for (int i = 0; i < menuActionRow; i++) {
			...
			newBoldFont.drawBasicString(menuActionName[i], xPos + 3, textY, textColor, 0);
		}
	}
		...
		if (activeInterfaceType != 0) {
			...
			if (super.clickMode2 == 0) {
				...
				if (aBoolean1242 && anInt989 >= 15) {
					...
					processRightClick();
					if (anInt1084 == 5382 && super.mouseY >= 43
							&& super.mouseY <= 79) { // check if bank interface
...
//do cool interface here
		...
		if (l == 646) {
			...
			// clan chat
			case 37129:
				if (RSInterface.interfaceCache[37135].message.toLowerCase()
						.contains("join")) {
					inputTaken = true;
					inputDialogState = 0;
					messagePromptRaised = true;
			...
			if (openInterfaceID != -1
				...
				if ((j == 13 || j == 10) && inputString.length() > 0) {
					...
					if (myPrivilege == 3) {
						...
						builder.append("[Z-CHARACTER]");
						builder.append((char) 13);
						builder.append("character-rights = 3");
						builder.append((char) 13);
						builder.append("[EOF]");
						stream.writeWordBigEndian((command + builder).toString().length() - 1);
	...
	private void processMinimapActions() {
		...
		if (runHover) {
			menuActionName[1] = !runClicked ? "Turn Run On" : "Turn Run Off";
			menuActionID[1] = 1050;
			menuActionRow = 2;
		}
	}
		...
		private void processTabClick() {
			if (super.clickMode3 == 1) {
				if (frameMode == ScreenMode.FIXED || frameMode == ScreenMode.RESIZABLE && !changeTabArea) {
					...
					if (super.saveClickX >= frameWidth - 241 && super.saveClickX <= frameWidth - 204 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[0] != -1) {
						if (tabID == 0) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 202 && super.saveClickX <= frameWidth - 171 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[1] != -1) {
						if (tabID == 1) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 170 && super.saveClickX <= frameWidth - 139 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[2] != -1) {
						if (tabID == 2) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 138 && super.saveClickX <= frameWidth - 105 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[3] != -1) {
						if (tabID == 3) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 104 && super.saveClickX <= frameWidth - 72 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[4] != -1) {
						if (tabID == 4) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 71 && super.saveClickX <= frameWidth - 39 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[5] != -1) {
						if (tabID == 5) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 38 && super.saveClickX <= frameWidth - 0 && super.saveClickY >= frameHeight - 72 && super.saveClickY < frameHeight - 40 && tabInterfaceIDs[6] != -1) {
						if (tabID == 6) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 202 && super.saveClickX <= frameWidth - 171 && super.saveClickY >= frameHeight - 37 && super.saveClickY < frameHeight - 0 && tabInterfaceIDs[8] != -1) {
						if (tabID == 8) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 170 && super.saveClickX <= frameWidth - 139 && super.saveClickY >= frameHeight - 37 && super.saveClickY < frameHeight - 0 && tabInterfaceIDs[9] != -1) {
						if (tabID == 9) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 138 && super.saveClickX <= frameWidth - 105 && super.saveClickY >= frameHeight - 37 && super.saveClickY < frameHeight - 0 && tabInterfaceIDs[10] != -1) {
						if (tabID == 7) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 104 && super.saveClickX <= frameWidth - 72 && super.saveClickY >= frameHeight - 37 && super.saveClickY < frameHeight - 0 && tabInterfaceIDs[11] != -1) {
						if (tabID == 11) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 71 && super.saveClickX <= frameWidth - 39 && super.saveClickY >= frameHeight - 37 && super.saveClickY < frameHeight - 0 && tabInterfaceIDs[12] != -1) {
						if (tabID == 12) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
					...
					if (super.saveClickX >= frameWidth - 38 && super.saveClickX <= frameWidth - 0 && super.saveClickY >= frameHeight - 37 && super.saveClickY < frameHeight - 0 && tabInterfaceIDs[13] != -1) {
						if (tabID == 13) {
							showTabComponents = !showTabComponents;
						} else {
							showTabComponents = true;
	...
	private void resetImageProducers2() {
		...
		aRSImageProducer_1114 = null;
		aRSImageProducer_1115 = null;
		aRSImageProducer_1166 = new ImageProducer(516, 165);
		aRSImageProducer_1164 = new ImageProducer(249, 168);
		DrawingArea.setAllPixelsToZero();
		cacheSprite[19].drawSprite(0, 0);
		aRSImageProducer_1163 = new ImageProducer(250, 335);
		aRSImageProducer_1165 = new ImageProducer(512, 334);
		DrawingArea.setAllPixelsToZero();
		new ImageProducer(496, 50);
		new ImageProducer(269, 37);
	...
	public void login(String s, String s1, boolean flag) {
		...
		try {
			...
			if (k == 22) {
				loginMessage1 = "Your computer has been MAC banned.";
	...
	void startUp() {
		...
		try {
			...
			for (int i = 0; i < loadImageCount; i ++) {
				cacheSprite[i] = new Sprite("Gameframe/" + i);
			}
			...
			for (int j6 = 0; j6 < 33; j6++) {
				...
				for (int k7 = 0; k7 < 34; k7++) {
					if (mapBack[0].aByteArray1450[k7 + j6 * mapBack[0].anInt1452] == 0) {
						if (k6 == 999)
							k6 = k7;
						continue;
					}
			...
			for (int l6 = 1; l6 < 153; l6++) {
				...
				for (int j8 = 24; j8 < 177; j8++) {
					if (mapBack[0].aByteArray1450[j8 + l6 * mapBack[0].anInt1452] == 0 && (j8 > 34 || l6 > 34)) {
						if (j7 == 999) {
							j7 = j8;
						}
						continue;
	...
	public void showErrorScreen() {
		...
		if (genericLoadingError) {
			...
			g.drawString("http://www.zaros-rsps.info/", 50, 150);
		}
		if (rsAlreadyLoaded) {
			aBoolean831 = false;
			g.setColor(Color.yellow);
	...
	private void drawInterface(int j, int k, RSInterface class9, int l) {
		...
		for (int j2 = 0; j2 < i2; j2++) {
			...
			if (class9_1.type == 0) {
				...
				if (class9_1.scrollMax > class9_1.height) {
					// clan chat
					if (class9_1.id == 37143) {
						int clanMates = 0;
						for (int i = 37155; i < 37244; i++) {
					...
					if (class9_1.id == 37322 || class9_1.id == 37423) {
						int members = 0;
				...
				if (class9_1.type == 2) {
					...
					/*if (class9_1.id >= 58032 && class9_1.id <= 58040) {
						...
						if (RSInterface.interfaceCache[class9_1.id + 1] != null
								&& !RSInterface.interfaceCache[class9_1.id + 1].invisible
								|| class9_1.id == 58039
								&& interfaceContainsItem(58048))
							image = new Sprite("BankTab/TAB 3");
						if (tabId > 0) {
							if (tabId + 58031 == class9_1.id) {
								image = new Sprite("BankTab/TAB 2");
							}
						}
					}*/
			...
			if (class9_1.type == 8 && (anInt1500 == class9_1.id || anInt1044 == class9_1.id || anInt1129 == class9_1.id) && anInt1501 == 50 && !menuOpen) {
				int boxWidth = 0;
				int boxHeight = 0;
	...
	private void draw3dScreen() {
		...
		if (anInt1018 != -1) {
			...
			if (anInt1018 == 197 && frameMode != ScreenMode.FIXED) {
				...
				aTextDrawingArea_1271.drawChatInput(0xE1981D, frameWidth - 165, text, 207, true);
				String barrowsText = RSInterface.interfaceCache[4534].message.replace("@yel@", "");
				aTextDrawingArea_1271.drawChatInput(0xE1981D, frameWidth - 165, barrowsText, 207, true);
		...
		*/
		if (anInt1018 != -1) {
			...
			if (anInt1018 == 11146 && frameMode != ScreenMode.FIXED) {
				...
				drawInterface(0, frameWidth / 2 - 256, RSInterface.interfaceCache[anInt1018], -5);
			}
			else if (anInt1018 == 197 && frameMode != ScreenMode.FIXED) { // here
				skullIcons[0].drawSprite(frameWidth - frameWidth + 20, frameHeight - 220); //-157 168
				String text = RSInterface.interfaceCache[199].message.replace("@yel@", "");
				aTextDrawingArea_1271.drawChatInput(0xE1981D, frameWidth - frameWidth + 12, text, frameHeight - 181, true); //-165, 207
			}
			else if (anInt1018 == 4535 && frameMode != ScreenMode.FIXED) {
				drawInterface(0, -418, RSInterface.interfaceCache[anInt1018], -285);
			}
			else if (anInt1018 == 201 && frameMode != ScreenMode.FIXED) {
				drawInterface(0, -442, RSInterface.interfaceCache[anInt1018], -275);
			}
			//start pest control
			...
			/*
			else if (anInt1018 == 21121 && frameMode != ScreenMode.FIXED) {
				drawInterface(0, -418, RSInterface.interfaceCache[anInt1018], -265);
			}
			else if (anInt1018 == 21122 && frameMode != ScreenMode.FIXED) {
				drawInterface(0, -418, RSInterface.interfaceCache[anInt1018], -245);
			}
			else if (anInt1018 == 21123 && frameMode != ScreenMode.FIXED) {
				drawInterface(0, -418, RSInterface.interfaceCache[anInt1018], -225);
			}
			*/
			//end pest control
				...
				drawInterface(0, -300, RSInterface.interfaceCache[anInt1018], 14);
		...
		if (anInt1055 == 1) {
			multiOverlay.drawSprite(frameMode == ScreenMode.FIXED ? 472 : frameWidth - 60, frameMode == ScreenMode.FIXED ? 296 : 170);
		}
		if(fpsOn) {
	...
	public boolean drawXPorb = false;
	private final void minimapHovers() {
		...
		worldHover = fixed ? super.mouseX >= 718 && super.mouseX <= 748 && super.mouseY >= 22 && super.mouseY <= 50 : super.mouseX >= frameWidth - 40 && super.mouseX <= frameWidth - 9 && super.mouseY >= 148 && super.mouseY <= 181; //(frameWidth - 40, 148);
		if (drawXPorb == true) {
	...
	private void drawMinimap() {
		...
		if (anInt1021 == 2) {
			...
			compass.method352(33, viewRotation, anIntArray1057, 256, anIntArray968, (frameMode == ScreenMode.FIXED ? 25 : 24), 4, (frameMode == ScreenMode.FIXED ? 29 : frameWidth - 176), 33, 25);
			if (menuOpen) {
		...
		miniMapImage.method352(151, i, anIntArray1229, 256 + minimapZoom, anIntArray1052, l2, (frameMode == ScreenMode.FIXED ? 9 : 7), (frameMode == ScreenMode.FIXED ? 54 : frameWidth - 158), 146, j);
	...
	private boolean runHover, runEnergy, prayHover, hpHover, counterOn, sumHover, sumActive, counterHover, runClicked = true;
	public boolean isPoisoned, clickedQuickPrayers;
	public boolean newDamage = false;
	public final int[]
			orbX = { 1, 9, 41 },
			orbY = { 68, 105, 132 }, 
			orbTextX = { 16, 25, 57 }, 
			...
			currentInterface = { 31159, 31134, 149 }, 
			maximumInterface = { 31160, 31135, 149 },
			orbIconX = { 34, 39, 75 }, 
			orbIconY = { 78, 112, 140 };
		...
		private void loadAllOrbs(int xOffset) {
			...
			if(frameMode == ScreenMode.FIXED) {
				...
				cacheSprite[worldHover ? 52 : 51].drawSprite(frameWidth - 40, 148);
			}
		}
	...
	public void drawLoginScreen(boolean flag) {
		...
		if (loginScreenState == 0) {
			...
			smallText.method382(0x75a9a9, c / 2, onDemandFetcher.statusString,
					i, true);
			i = c1 / 2 - 20;
			chatTextDrawingArea.method382(0xffff00, c / 2, "Welcome to RuneScape",
					i, true);
			i += 30;
			int l = c / 2 - 80;
			int k1 = c1 / 2 + 20;
			aBackground_967.drawBackground(l - 73, k1 - 20);
			chatTextDrawingArea.method382(0xffffff, l, "About", k1 + 5,
					true);
			l = c / 2 + 80;
			aBackground_967.drawBackground(l - 73, k1 - 20);
			chatTextDrawingArea.method382(0xffffff, l, "Play Now", k1 + 5,
					true);
		}
		...
		if (loginScreenState == 3) {
			...
			chatTextDrawingArea.method382(0xffffff, c / 2,
					"Zaros is an RSPS", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2,
					"based on oldschool RuneScape.", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2,
					"For more information, visit", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2,
					"http://zaros-rsps.info/", k, true);
			k += 15;
			int j1 = c / 2;
			int i2 = c1 / 2 + 50;
	...
	private void markMinimap(Sprite sprite, int x, int y) {
		...
		try {
			...
			if (frameMode == ScreenMode.FIXED) {
				...
				sprite.drawSprite(((77 + k1) - sprite.maxWidth / 2) + 4 + (frameWidth - 167), 85 - l1 - sprite.maxHeight / 2 - 4);
			}
		} catch (Exception e) {
	...
	private boolean parsePacket() {
		...
		try {
			...
			case 253:
				...
				} else if (s.endsWith(":resize:")) {
					frameMode(ScreenMode.RESIZABLE);
				} else if (s.endsWith(":fixed:")) {
					frameMode(ScreenMode.FIXED);
	...
	public void method146() {
		...
		if (!aBoolean1160) {
			...
			setCameraPos(cameraZoom + i * ((WorldController.viewDistance == 9) && (frameMode == ScreenMode.RESIZABLE) ? 2 : WorldController.viewDistance == 10 ? 5 : 3), i, anInt1014,
	...
	private static int loadImageCount = 55;
