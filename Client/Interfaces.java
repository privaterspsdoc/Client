public class Interfaces extends RSInterface {
	...
	public static void optionTab(TextDrawingArea[] tda) {
		...
		addConfigButton(913, 904, 48, 48, "/Options/SPRITE", 40, 40,
				"Toggle XP Counter", 0, 5, 170);
		addConfigButton(915, 904, 47, 47, "/Options/SPRITE", 40, 40,//33
				"Toggle Screen Size", 0, 5, 171);
	...
	public static void clanChatSetup(TextDrawingArea[] tda) {
		RSInterface rsi = addInterface(37300);
		...
		interfaceCache[37302].atActionType = 3;
	...
	public static void itemsOnDeath(TextDrawingArea[] wid) {
		...
		addText(17107, "Zaros", wid, 1, 0xffcc33);
	...
	public static void clanChatTab(TextDrawingArea[] tda) {
		RSInterface tab = addTabInterface(37128);
		...
		/* Text area */
		RSInterface list = addTabInterface(37143);
